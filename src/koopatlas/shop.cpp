...
const dWMShop_c::ItemTypes dWMShop_c::Inventory[10][12] = { 
	{ // Yoshi's Island
		MUSHROOM, FIRE_FLOWER, ICE_FLOWER, ONE_UP,
		STARMAN, ONE_UP, STARMAN,
		HAMMER, ICE_FLOWER, ONE_UP, ICE_FLOWER, HAMMER
	},
	{ // Desert
		FIRE_FLOWER, ICE_FLOWER, STARMAN, HAMMER,
		ONE_UP, PROPELLER, ONE_UP,
		FIRE_FLOWER, HAMMER, ONE_UP, HAMMER, FIRE_FLOWER
	},
	{ // Mountain
		HAMMER, ICE_FLOWER, PROPELLER, STARMAN,
		ICE_FLOWER, MUSHROOM, HAMMER,
		MINI_SHROOM, ONE_UP, ICE_FLOWER, MUSHROOM, MINI_SHROOM
	},
	{ // Japan
		FIRE_FLOWER, ICE_FLOWER, MINI_SHROOM, ONE_UP,
		FIRE_FLOWER, PROPELLER, FIRE_FLOWER,
		ICE_FLOWER, PROPELLER, STARMAN, MUSHROOM, ICE_FLOWER
	},
	{ // FreezeFlame
